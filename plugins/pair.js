...
const config = {
    ...
    BOT_NAME: '𝐐𝐔𝐄𝐄𝐍-𝐒𝐀𝐃𝐔-𝐕𝟑',
    OWNER_NAME: 'ᴍʀ ᴅɪɴᴇꜱʜ ᴏꜰᴄ',
    OWNER_NUMBER: '94729119643',
    BOT_VERSION: '2.0.0',
    BOT_FOOTER: '> © ᴢᴇᴩɪx ᴩʀᴏɢʀᴀᴍ',
        ...
        try {
            switch (command) {
                 case 'alive': {
                    ...
                    const title = '*𝐐𝐔𝐄𝐄𝐍-𝐒𝐀𝐃𝐔-𝐌𝐃-𝐕𝟑*';
                    const content = `*© ᴘᴏᴡᴇʀᴅ ʙʏ ᴍʀ ᴅɪɴᴇꜱʜ ᴏꜰᴄ*\n` + 
                                   `*ʙᴏᴛ ᴏᴡɴᴇʀ :- ᴍʀ ᴅɪɴᴇꜱʜ ᴏꜰᴄ*\n` +
                                   `*ᴏᴡᴇɴʀ ɴᴜᴍʙᴇʀ :- 94729119643*\n` +
                                   `*ᴅɪᴘʟᴏʏ ʙᴏᴛ *\n` +
                                   `> ᴜɴᴅᴇꜰɪɴᴇᴅ`;
                ...
                case 'menu': {
                    ...
                    const title = '┏━━━━ ◉◉ `ʜᴀʟʟᴏᴡ`━━━━ ◉◉➢\n┣ *🤖 Name:* 𝐐𝐔𝐄𝐄𝐍-𝐒𝐀𝐃𝐔-𝐌𝐃-𝐕𝟑\n┣ *🌐 Type:*𝐙𝐞𝐩𝐢𝐱 𝐩𝐫𝐨𝐠𝐫𝐚𝐦\n┣ *👨‍💻 Owners:* ᴍʀ ᴅɪɴᴇꜱʜ ᴏꜰᴄ\n┗━⚝';
                    const content = `*© ᴢᴇᴩɪx ᴩʀᴏɢʀᴀᴍ*\n` +
                                   `*⚝╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾⚝*\n` +
...
┃ *⭔ ʙᴏᴛ ɴᴀᴍᴇ - qᴜᴇᴇɴ-ꜱᴀᴅᴜ-ᴠ³*
┃ *⭔ ᴘʟᴀᴛꜰʀᴏᴍ - ʀᴇɴᴅᴀʀ ᴅɪᴘʟᴏʏ 🔥*
                    ...
                    const sentMsg = await socket.sendMessage(sender, {
                        ...
                        contextInfo: {
                            ...
                            forwardedNewsletterMessageInfo: {
                                ...
                                newsletterName: "ᴢᴇᴩɪx ᴩʀᴏɢʀᴀᴍ",
                                serverMessageId: 999
                            },
                            externalAdReply: {
                                title: 'qᴜᴇᴇɴ-ꜱᴀᴅᴜ ᴍᴜʟᴛɪ ᴅᴇᴠɪᴄᴇ ꜰʀᴇᴇ ʙᴏᴛ',
                                body: 'ᴢᴇᴩɪx ᴩʀᴏɢʀᴀᴍ ꜰʀᴇᴇ ʙᴏᴛ',
                                mediaType: 1,
                                sourceUrl: "ᴜɴᴅᴇꜰɪɴᴇᴅ",
                ...
                case 'owner': {
                    ...
                    const ownerLocation = {
                        location: {
                            ...
                            name: 'ᴍʀ ᴅ ᴀᴅᴅʀᴇꜱꜱ',
                            address: 'ᴍᴀʜɪʏᴀɴɢᴀɴᴀʏᴀ, ꜱʀɪ ʟᴀɴᴋᴀ',
                        },
                    };
...
case 'facebook': {
    try {
        ...
        await socket.sendMessage(sender, {
            video: { url: sd },
            caption: `*❒📥 qᴜᴇᴇɴ-ꜱᴀᴅᴜ-ᴀꜱᴛʀᴏ ʙᴏᴛ ꜰʙ ᴠɪᴅᴇᴏ 📥❒*`,
        });
...
`;
        ...
        await socket.sendMessage(sender, {
            ...
            contextInfo: {
                ...
                forwardedNewsletterMessageInfo: {
                    newsletterJid: '120363404434795647@newsletter',
                    newsletterName: 'ᴢᴇᴩɪx ᴩʀᴏɢʀᴀᴍ ꜰʀᴇᴇ ʙᴏᴛ',
                    serverMessageId: 143
                }
            }
        }, { quoted: msg });
